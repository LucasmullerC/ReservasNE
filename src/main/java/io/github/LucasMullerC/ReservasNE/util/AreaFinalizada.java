...
public class AreaFinalizada
{
    private File storageFile;
    private ArrayList<Areas> values;
    private Areas A;
    
    public AreaFinalizada(final File file) {
    ...
    public void save() {
        try {
            ...
            for (final Areas value : this.values) {
                ...
                out.newLine();
                out.write("<description>Construido por: " + value.getCredito() + "</description>");
                out.newLine();
